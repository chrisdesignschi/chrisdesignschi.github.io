...
(function() {
  var APPS = [
    ...
    { id: "muaytracker", name: "Muay Tracker", desc: "Class tracker", icon: "flame", href: "https://chriszhu.com/muaytracker/" },
  ];
